...
public class FoldingCellListAdapter extends ArrayAdapter<Item> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (cell == null) {
            ...
            viewHolder.headImage02 = (ImageView) cell.findViewById(R.id.content_avatar);
...
//        viewHolder.headImage.setImageDrawable(item.getImage());
        viewHolder.headImage.setImageResource(item.getImage());
        viewHolder.headImage02.setImageResource(item.getImage02());
