...
public final class MCCustomToast extends Toast {
    ...
    public MCCustomToast(Context context) {
        ...
        View v1 = LayoutInflater.from(context).inflate(R.layout.toast_style_center, null);
        this.setView(v1);
    ...
    public final void setType(int type) {
        if (this.tipImage != null) {
            switch (type) {
                case 1: {
                    this.tipImage.setBackgroundResource(R.mipmap.jd_toast_exclamation);
                    return;
                }
                case 2: {
                    this.tipImage.setBackgroundResource(R.mipmap.jd_toast_tick);
                    return;
                }
            }
        }
