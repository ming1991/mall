 ...
 */
public class DCVAnimatedExpandableListView extends ExpandableListView {
    /*
    ...
    public DCVAnimatedExpandableListView(Context context) {
        super(context);
    }

    public DCVAnimatedExpandableListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DCVAnimatedExpandableListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public static abstract class AnimatedExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        private DCVAnimatedExpandableListView parent;

        private static final int STATE_IDLE = 0;
        private static final int STATE_EXPANDING = 1;
        private static final int STATE_COLLAPSING = 2;

        private void setParent(DCVAnimatedExpandableListView parent) {
            this.parent = parent;
        }
